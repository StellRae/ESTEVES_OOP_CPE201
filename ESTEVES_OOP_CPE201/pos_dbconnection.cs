...
namespace ESTEVES_OOP_CPE201
{
    internal class pos_dbconnection
    {
        ...
        public void pos_connString()
        {
            ...
            pos_connectionString = "Data Source = C203-15; Initial Catalog = POSDB; user id = SA; password = B1Admin123@";
        ...
        {
            pos_sql =
                "SELECT pos_empRegTbl.emp_id, emp_fname, emp_surname, " +
                "pos_terminal_no, account_type " +
                "FROM pos_empRegTbl " +
                "INNER JOIN useraccountTbl " +
